...
void test0() {
    ...
    std::cout << "create CS225::Integer(1)" << std::endl;
	CS225::Integer val( 1 );
    std::cout << "insert CS225::Integer(1) at 1" << std::endl;
    array.Insert( 1, val );
    std::cout << "array = " << array << std::endl;

    std::cout << "create CS225::Integer(2)" << std::endl;
	CS225::Integer val2( 2 );
    std::cout << "insert CS225::Integer(2) at 5" << std::endl;
    array.Insert( 5, val2 );
    std::cout << "array = " << array << std::endl;
}
void test1() {
    ...
    std::cout << "create CS225::Integer(1)" << std::endl;
	CS225::Integer val( 1 );
    std::cout << "insert CS225::Integer(1) at 5" << std::endl;
    array.Insert( 5, val );
...
void test3() {
    ...
    std::cout << "create CS225::Integer(6)" << std::endl;
	CS225::Integer val( 6 );
    std::cout << "insert CS225::Integer(6) at 3 and 5" << std::endl;
    array[3] = val;
    array[5] = val;
...
void test4() {
    ...
    for ( int i=0; i<6; ++i ) {
        array[i] = i+2; // use implicit conversion int->CS225::Integer
    }
...
void test10() {
    // correctness self-assignment test in CS225::Array
	CS225::Integer::noise = false;
    std::cout << "create empty array" << std::endl;
	CS225::Array array;
